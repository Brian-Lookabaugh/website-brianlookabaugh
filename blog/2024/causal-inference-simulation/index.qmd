...
image: "figures/att_distribution.png"
toc: true
toc-location: "left"
toc-title: "Contents"
categories:
...
#| code-fold: true
#| fig-cap: "Simple DAG Showing Confounding"
...
#| code-fold: true
#| fig-cap: "Simple DAG Showing Randomization of Treatment"
...
#| fig-cap: "Unobserved Confounder Sensitivity Analysis"
...
```{r}
#| code-fold: true
#| fig-cap: "DAG Incluing a Mediator"
...
```{r}
#| code-fold: true
#| fig-cap: "DAG Incluing a Collider"
...
```{r}
#| code-fold: true
#| fig-cap: "DAG Incluing Ancestors of Treatment and Outcome"
