...
date: 2026-04-05
description: "Check out this blog to learn about what MSMs are, why you might use them, and some of the technical issues you'll run into along the way."
image: "figures/feedback_loop.png"
toc: true
execute:
  warning: false
  error: false
...
[^2]: [Chatton and Rohrer (2024)](https://psycnet.apa.org/record/2024-71804-001) discuss several of these alternative applications such as inverse probability of missigness weights (IPMW) for handling missingness, inverse probability of sampling weights (IPSW) for sampling, and inverse probability of censoring weights (IPCW) for survival analysis.
...
By no means was this blog exhaustive, however. For example, I didn't go over using [augmented IPWs](https://www.cambridge.org/core/journals/political-analysis/article/abs/an-introduction-to-the-augmented-inverse-propensity-weighted-estimator/4B1B8301E46F4432C4DCC91FE20780DB) or [incorporating fixed effects](https://www.mattblackwell.org/files/papers/psfe.pdf) to name a couple. I am writing a blog and not a textbook, after all. But if you're seriously about implementing MSMs in an academic or a professional setting, topics such as those mentioned should be something that you research and consider.
